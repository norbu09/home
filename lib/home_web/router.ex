defmodule HomeWeb.Router do
  ...
  scope "/", HomeWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {HomeWeb.LiveUserAuth, :live_user_required}
      #
      ...
      live "/briefs/prompts", PromptLive, :index
  ...
  scope "/api/json" do
    ...
    forward "/", HomeWeb.AshJsonApiRouter
  end
  ...
  scope "/", HomeWeb do
    ...
    sign_out_route AuthController, "/sign-out",
      overrides: [HomeWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]
    ...
    confirm_route Home.Accounts.User, :confirm_new_user,
      auth_routes_prefix: "/auth",
      overrides: [HomeWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]

    # Remove this if you do not use the magic link strategy.
    magic_sign_in_route(Home.Accounts.User, :magic_link,
      auth_routes_prefix: "/auth",
      overrides: [HomeWeb.AuthOverrides, AshAuthentication.Phoenix.Overrides.Default]
    )
  end
